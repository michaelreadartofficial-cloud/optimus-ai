...
const ScriptsPage = ({ savedVideos }) => {
  ...
  // Approx 3 words/sec for short-form narration
...
const IdeasPage = ({ savedVideos, setCurrentPage }) => {
...
const ProjectsPage = ({ savedVideos, savedScripts }) => {
